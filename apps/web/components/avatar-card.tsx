...
export const AvatarCard = (props: AvatarCardProps) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div
        className={
          "flex aspect-square flex-col items-center justify-center overflow-hidden rounded-full border-2 border-primary transition-shadow duration-200 hover:shadow-md"
        }
